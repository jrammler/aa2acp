...
int main() {
  // SPS/PPS emitted by the development Android phone. test head unit's Pi hardware
  // decoder rejects this metadata until the h264_metadata filter normalizes it.
